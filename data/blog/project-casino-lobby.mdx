...
![lobbylist](/static/images/bowie-threeinarow-game.png)
...
It appends the JWT token to headers on each API request, check out middleware.ts in root dir at [ryan-west-casino/bowie-frontend](https://github.com/ryan-west-casino/bowie-frontend).
